                ...
                <main className="flex gap-5">
                    ...
                    <div className='w-full mb-5'>
                        <div className="flex justify-between items-center mb-4">
                            <h1 className='font-semibold text-2xl'>My Notes</h1>
                            <button className='bg-blue-200 px-4 py-2 rounded-sm' onClick={() => navigate('/add-note')}>Add New Note</button>
                        </div>
                        {/* Content Start */}
                        {
                            content ? (
                                content?.map((data, i) => (
                                    <div className="bg-white px-7 py-8 rounded-sm border hover:bg-blue-50 mt-3" key={i}>
                                ...
                                <h1 className='text-center'>There are nothing yet...</h1>
                            )
                        }
                    </div>
                </main>
